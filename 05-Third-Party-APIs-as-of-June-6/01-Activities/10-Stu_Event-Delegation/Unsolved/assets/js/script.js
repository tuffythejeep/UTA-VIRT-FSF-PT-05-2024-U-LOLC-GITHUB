...
//to `shoppingListEl` to listen for a click event on 
//any element with a class of `.delete-item-btn` and execute the function created above
shoppingListEl.on('click', '.delete-item-btn', handleRemoveItem);

shoppingFormEl.on("submit", removeFromList);